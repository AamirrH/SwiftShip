...
Google OAuth starts at `${VITE_API_BASE_URL}/oauth2/authorization/google` through the gateway and
returns with an `accessToken` query parameter, which the app stores automatically.
